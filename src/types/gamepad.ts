...
export interface GamepadHandler {
    ...
    stop(): void;
    poll(): void;
    addEventListener(type: 'connect' | 'disconnect', listener: (gamepad: GamepadState) => void): void;
    removeEventListener(type: 'connect' | 'disconnect', listener: (gamepad: GamepadState) => void): void;
}
